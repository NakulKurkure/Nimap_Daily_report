...
public class JobServiceImpl implements JobServiceInterface{
	...
	public void addJob(JobDto jobDto) {
		...
		Role role=roleRepository.findById(jobDto.getRecruiterId()).orElseThrow(()-> new ResourceNotFoundException("Not Found RoleId..."));
	...
	@Override
	public void updateJob(JobDto jobDto,Long id) {
	
		roleRepository.findById(jobDto.getRecruiterId()).orElseThrow(()-> new ResourceNotFoundException("Not Found RoleId..."));
